return {
	ANNOUNCE_ADVENTUREFAIL = "Well. That sucked.",
	...
	ANNOUNCE_HOT = "The heat never really bothered me. Hellhound. Duh!",
	...
	DESCRIBE =
	{
        ...
        FLOTSAM = "That wood is probably too soggy to burn.",
        SUNKEN_BOAT = {
            GENERIC = "That mangy bird looks like he wants my stuff!",
            ABANDONED = "That boat deserves a funeral pyre.",
        },


        SUNKEN_BOAT_BURNT = "That's the best boat I ever saw!",

  		SUNKEN_BOAT_TRINKET_1 = "Maybe it'll point me towards fire?", --sextant
		SUNKEN_BOAT_TRINKET_2 = "Little boat.", --toy boat
		SUNKEN_BOAT_TRINKET_3 = "Where is your fire?", --candle
		SUNKEN_BOAT_TRINKET_4 = "It seems to be some sort of... thing.", --sea worther
		SUNKEN_BOAT_TRINKET_5 = "A bit soggy.", --boot
	},
